...
export class OracleEVM extends OracleAbstract {
  ...
  public async updateEntry(args: IEVMOracleEntry): Promise<OracleResponse> {
    ...
    //   contractName: entry.contractJSON.contractName,
  ...
  public async readEntry(args: IEVMOracleEntry): Promise<OracleResponse> {
    ...
    //   connector: this.connector,
    //   signingCredential: this.signingCredential,
    //   contractName: args.contractJSON.contractName,
    //   contractAddress: args.contractAddress,
    //   participant: this.id,
    // };
  ...
  public async subscribeContractEvent(
    ...
    subscriber.on("data", (log: unknown) => {
      ...
      const output_params = this.extractNamedParams(decoded);
  ...
  private extractNamedParams(decodedEvent: DecodedParams): string[] {
    const params = [];
