...
export class OracleRegisterTask implements IWebServiceEndpoint {
  public static readonly CLASS_NAME = "OracleRegisterTask";

  private readonly log: Logger;

  public get className(): string {
    return OracleRegisterTask.CLASS_NAME;
  }
