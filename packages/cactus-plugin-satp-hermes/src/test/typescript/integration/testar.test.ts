...
*/
  besuEnv = (global as any).__BESU_ENV__;
  fabricEnv = (global as any).__FABRIC_ENV__;
  ethereumEnv = (global as any).__ETHEREUM_ENV__;

  db_local_config = (global as any).__DB_LOCAL_CONFIG__ = db_local_config;
  db_remote_config = (global as any).__DB_REMOTE_CONFIG__ = db_remote_config;
  db_local = (global as any).__DB_LOCAL__ = db_local;
  db_remote = (global as any).__DB_REMOTE__ = db_remote;
});
