...
// import { EvmFungibleAsset } from "@hyperledger/cactus-plugin-satp-hermes/src/main/typescript/cross-chain-mechanisms/bridge/ontology/assets/evm-asset";
// import { FabricLeaf } from "@hyperledger/cactus-plugin-satp-hermes/src/main/typescript/cross-chain-mechanisms/bridge/leafs/fabric-leaf";
...
//       sourceAsset = this.setFabricAsset(senderAddress as string, amount.toString());
...
//       receiverAsset = this.setFabricAsset(receiverAddress as string, amount.toString(),);
//     }
...
//   private setBesuAsset(owner: string, contractAddress: string, amount: string) {
//     return {
//       owner: owner,
//       contractName: CbdcBridgingAppDummyInfrastructure.SATP_CONTRACT,
//       contractAddress,
//       id: CbdcBridgingAppDummyInfrastructure.BESU_ASSET_ID,
//       referenceId: CbdcBridgingAppDummyInfrastructure.BESU_ASSET_ID,
//       amount,
...
//   private setFabricAsset(owner: string, amount: string) {
//     return {
//       owner: owner,
//       contractName: CbdcBridgingAppDummyInfrastructure.SATP_CONTRACT,
//       id: CbdcBridgingAppDummyInfrastructure.FABRIC_ASSET_ID,
//       referenceId: CbdcBridgingAppDummyInfrastructure.FABRIC_ASSET_ID,
//       amount,
//       tokenType: TokenType.NonstandardNonfungible,
//       networkId: {
//         id: "FABRIC",
